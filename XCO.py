...
def predict_metallicity(
        Mstar, calibration='O3N2(PP04)', MZR='Sanchez+19',
        Rgal=None, Re=None, gradient=None):
    """
    ...
    mass-metallicity relation for a particular calibration.
    ...
    calibration : {'O3N2(PP04)', 'R23(T04)', 'R23(R11)', 't2(P12)'}
        Metallicity calibration to adopt. Default is 'O3N2(PP04)'
    ...
    calibrations = ['O3N2(PP04)', 'R23(T04)', 'R23(R11)', 't2(P12)']
    ...
    if MZR == 'Sanchez+19':  # SAMI
        if calibration == 'O3N2(PP04)':
            a = 8.73  # +- 0.03
            b = 0.010  # +- 0.002
        elif calibration == 'R23(T04)':
            a = 8.84  # +- 0.02
            b = 0.007  # +- 0.001
        elif calibration == 'R23(R11)':
            a = 8.48  # +- 0.02
            b = 0.004  # +- 0.001
        elif calibration == 't2(P12)':
            a = 8.84  # +- 0.02
            b = 0.008  # +- 0.001
        c = 3.5
        ...
        # this calibration likely underestimates log(O/H)
    ...
    if gradient == 'Sanchez+14':
        if not calibration == 'O3N2(PP04)':
            print("Beware: "
                  "Sanchez+14 adopted the O3N2(PP04) calibration")
...
def predict_alphaCO10(
        prescription='Galactic', iterative=False,
        PHANGS_Zprime=None,
    ...
    + prescription='Amorin+16'
        ...
        1. `A16_logOH_PC09` [unitless]
            metallicity in terms of PC09 N2 calibration
    ...
    + prescription='Accurso+17'
        ...
        1. `A17_logOH_PP04` [unitless]
            metallicity in terms of PP04 O3N2 calibration
    ...
    + prescription='Chiang+20'
        Required input parameters:
        1. `C20_logOH` [unitless]
            metallicity from direct measurements or KK04 calibration
            (see Kobulnicky & Kewley 2004)
        Reference: Chiang et al. (2020, in preparation)

    Parameters
    ----------
    prescription : string, optional
        The alphaCO prescription to adopt (default='Galactic')
    ...
    **kwargs
    ...
    prescriptions = [
        'Galactic', 'PHANGS', 'Narayanan+12', 'Bolatto+13',
        'Amorin+16', 'Accurso+17', 'Chiang+20']

    if prescription not in prescriptions:
        raise ValueError(
            "Available choices of `prescription`: "
            "{}".format(prescriptions))

    elif prescription == 'Galactic':
    ...
    elif prescription == 'Chiang+20':
        if C20_logOH is None:
            raise ValueError(
                "Chiang+20 prescription needs `C20_logOH`")
        a = 0.29  # +0.12 -0.13
        b = -1.91  # +0.34 -0.33
        alphaCO = 10**(
            a + b * np.atleast_1d(C20_logOH - 8.69))
